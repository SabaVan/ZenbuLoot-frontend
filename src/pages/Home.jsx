...
const menu = [
  ...
  { id: 2, name: "Pick-a-Chance", path: "/pick-a-chance", image: `${base}images/menu/pick-a-chance.png` },
  { id: 3, name: "My Items", path: "/my-items", image: `${base}images/menu/my_items.png` },
  { id: 4, name: "History", path: "/history", image: `${base}images/menu/history.png` },
  { id: 5, name: "About", path: "/about", image: `${base}images/menu/about.png` },
];
